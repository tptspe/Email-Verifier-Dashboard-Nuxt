<template>
  ...
  <div>
    <v-list-item-subtitle class="text-wrap"
      >The
      <span class="grey--text text--darken-4 font-weight-bold">transition</span>
      prop allows you to apply a transition to the alert which is viewable when
      the component hides and shows. For more information, you can checkout any
      of Vuetify's prebuilt transitions or review how to create your
      own.</v-list-item-subtitle
    >
    <div class="mt-4">
